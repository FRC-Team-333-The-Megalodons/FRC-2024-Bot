...
public class TwoPcCenter extends SequentialCommandGroup {
  PathPlannerPath path = PathPlannerPath.fromPathFile("Leave - Center");
  /** Creates a new TwoPcCenter. */
  public TwoPcCenter(Intake intake, Wrist wrist, Trolley trolley, Pivot pivot, Indexer indexer, Shooter shooter, LEDStrip ledStrip){
    addCommands(
