...
public class TwoPcAmpSide extends SequentialCommandGroup {
  /** Creates a new TwoPcAmpSide. */
   PathPlannerPath path = PathPlannerPath.fromPathFile("Leave - Amp Side");
  public TwoPcAmpSide(Intake intake, Wrist wrist, Trolley trolley, Pivot pivot, Indexer indexer, Shooter shooter, LEDStrip ledStrip){
    addCommands(
