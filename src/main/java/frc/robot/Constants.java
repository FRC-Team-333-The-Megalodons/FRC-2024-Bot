...
public final class Constants {
  ...
  public static final class WristConstants {
    ...
    public static final double INTAKE_SETPOINT_POS = 0.68; // 0.328485667705536;
    public static final double SHOOTING_SETPOINT_POS = 0.45; //0.15;
    public static final double AMP_SETPOINT_POS = 0.8;// 0.5;
  ...
  public static final class TrolleyConstants {
    ...
    public static final double TROLLEY_FURTHEST_IN_WHERE_PIVOT_CAN_CLEAR_BACK_BUMPER_AND_MOVE_ALL_THE_WAY_UP = 0.585;
  ...
  public static final class PivotConstants { 
    ...
    public static final double INTAKE_SETPOINT_POS = 0.165; // 0.149223078730577;
    public static final double SUBWOFFER_SETPOINT_POS = 0.0556640013916;
    public static final double PODIUM_SETPOINT_POS = 0.120947403023685;
    public static final double WING_SETPOINT_POS = 0.0;
    public static final double AMP_SETPOINT_POS = 0.45; // 0.464868961621724;
    ...
    public static final double MIN_INPUT = -0.3;
    public static final double MAX_INPUT = 0.3;
    public static final double PIVOT_MIN_DOWN = SUBWOFFER_SETPOINT_POS; // This is the lowest point the intake can be down
    public static final double PIVOT_MAX_UP = AMP_SETPOINT_POS; // This is also the Amp scoring position.
    // TODO: Redo these numbers with real robot
    public static final double PIVOT_FURTHEST_DOWN_WHERE_TROLLEY_CAN_MOVE = 0.19; // 0.149223078730577;
    public static final double PIVOT_UP_FAR_ENOUGH_THAT_TROLLEY_COULD_HIT_BACK_BUMPER = 0.225;
